...
export default function PanelPrincipalPage() {
  ...
  const modules: {
...

    {
      ...
      description:
        (
          "Controlá devoluciones, productos, pallets " +
          "y movimientos por concesionario."
        ),
      ...
      <div className="dashboard-container">
        ...
        <div className="dashboard-bienvenida">
          ...
          <div>
            ...
            <p>
              ...
              logística y acceso rápido a cada
              área de trabajo.
            </p>
        ...
        <section>
          ...
          <div className="section-heading">
            ...
            <small>
              Seleccioná un área para comenzar
            </small>
